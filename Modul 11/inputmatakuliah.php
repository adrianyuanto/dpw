...
<body>
    ...
    <div class="container">
        <div class="nav-link">
            <a href="viewmatakuliah.php">← Lihat Data Matakuliah</a> |
        </div>
        ...
        <form action="proses_inputmatakuliah.php" method="post">
            <fieldset>
                ...
                <p>
                    ...
                    <input type="number" name="sks" id="sks" placeholder="Jumlah SKS" min="1" max="6">
                </p>
                <p>
                    <label for="jam">Jam :</label>
                    <input type="number" name="jam" id="jam" placeholder="Jumlah Jam" min="1">
                </p>
            </fieldset>
            <p>
